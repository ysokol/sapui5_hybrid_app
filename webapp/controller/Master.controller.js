		...
		return BaseController.extend("my.sapui5_hybrid_app.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("my.sapui5_hybrid_app.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("OrderTotalGross", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("OrderTotalGross", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
