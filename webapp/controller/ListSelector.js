sap.ui.define([
		...
		return BaseObject.extend("my.sapui5_hybrid_app.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias my.sapui5_hybrid_app.model.ListSelector
			 */
			 ...
			 * @return {my.sapui5_hybrid_app.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
