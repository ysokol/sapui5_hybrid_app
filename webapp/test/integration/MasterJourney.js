...
sap.ui.define([
	...
	opaTest("MasterList Filtering on OrderTotalGross less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<OrderTotalGross>").
	...
	opaTest("MasterList Filtering on OrderTotalGross more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Currency>").
			and.iPressOKInViewSelectionDialog();
