sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("my/sapui5_hybrid_app/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#sapui5_hybrid_app-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#sapui5_hybrid_app-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("my.sapui5_hybrid_app.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["my/sapui5_hybrid_app/localService/mockserver"], function (mockserver) {
